...
class CheckOutPage extends StatefulWidget {
  ...
  const CheckOutPage({Key? key, required this.user, required this.total})
      : super(key: key);
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              flex: 7,
                              child: Text(widget.user.user_email),
                            )
                          ],
                        ),
                        Row(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            width: 300,
                            child: Text(
                                "From 9.00 A.M to 7.00 P.M\nPlease allow 20minutes for preparation"),
                          ),
                          SizedBox(height: 10),
                          Row(
                            children: [
                    ...
                    Container(
                      ...
                      child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            Order _order = new Order(widget.user.user_email,
                                _phone, _name, widget.total.toString());
